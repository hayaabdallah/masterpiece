               ...
               <div class="owl-carousel owl-theme home-slider">
                         ...
                         <div class="caption">
                              <div class="container">
                                   <div class="col-md-6 col-sm-12">
                                        <h1>Find best car with best price</h1>
                                        <h3>Ready for your ride?</h3>
                    ...
                    <div class="item item-third">
                         <div class="caption">
                              <div class="container">
                                   <div class="col-md-6 col-sm-12">
                                        <h1>Search ,book and rent car easily</h1>
                                        <h3>We are your best choice </h3>
                    ...
                    <div class="row">
                         ...
                         <div class="col-md-4 col-sm-4">
                              <div class="courses-thumb courses-thumb-secondary">
                                   ...
                                   <div class="courses-info">
                                        <a href="cars.html" class="section-btn btn btn-primary btn-block">Hybrid</a>
                                   </div>
                              </div>
                         </div>
                         ...
                         <div class="col-md-4 col-sm-4">
                              <div class="courses-thumb courses-thumb-secondary">
                                   ...
                                   <div class="courses-info">
                                        <a href="cars.html" class="section-btn btn btn-primary btn-block">Electric</a>
                                   </div>
                              </div>
                         </div>
                         ...
                         <div class="col-md-4 col-sm-4">
                              <div class="courses-thumb courses-thumb-secondary">
                                   ...
                                   <div class="courses-info">
                                        <a href="cars.html" class="section-btn btn btn-primary btn-block">Gasoline</a>
                                   </div>
                              </div>
                         </div>
                    </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="left-content">
                            ...
                            <ul class="featured-list">
                              <li><a href="#">If you want to book directly through a supplier, and not through a broker – choose C Rental</a></li>
                              <li><a href="#">this will give you better flexibility in terms of vehicle choices;</a></li>
                              <li><a href="#">you can reach us 24/7 </a></li>
                              <li><a href="#">Best quality and price </a></li>
                            </ul>
                        ...
                        <div class="col-md-6">
                          <div class="right-image">
                            <img src="assets/images/n.jpg" alt="" style="height:330px;width:550px;">
          ...
          <section>
               <div class="container">
                    <div class="row">
                         <div class="col-md-12 col-sm-12">
                              <div class="section-title text-center">
                                   <h2>Featured cars<small></small></h2>
                              </div>
                         </div>
                         ...
                         <div class="col-md-4 col-sm-4">
                              <div class="courses-thumb courses-thumb-secondary">
                                   ...
                                   <div class="courses-info">
                                        <a href="blog-post-details.html" class="section-btn btn btn-primary btn-block">More Details</a>
                                   </div>
                              </div>
                         </div>
                         ...
                         <div class="col-md-12 col-sm-12">
                              ...
                              <div class="owl-carousel owl-theme owl-client">
                                   <div class="col-md-4 col-sm-4">
                                        <div class="item">
                                             <div class="tst-image">
                                                  <img src="assets/images/tst-image-1-200x216.jpg" class="img-responsive" alt="">
                                             </div>
                                   ...
                                   <div class="col-md-4 col-sm-4">
                                        <div class="item">
                                             <div class="tst-image">
                                                  <img src="assets/images/tst-image-2-200x216.jpg" class="img-responsive" alt="">
                                             </div>
                                             <div class="tst-author">
                                                  <h4>Camila</h4>
                                   ...
                                   <div class="col-md-4 col-sm-4">
                                        <div class="item">
                                             <div class="tst-image">
                                                  <img src="assets/images/tst-image-3-200x216.jpg" class="img-responsive" alt="">
                                             </div>
                                             <div class="tst-author">
                                                  <h4>Barbie</h4>
                                   ...
                                   <div class="col-md-4 col-sm-4">
                                        <div class="item">
                                             <div class="tst-image">
                                                  <img src="assets/images/tst-image-4-200x216.jpg" class="img-responsive" alt="">
                                             </div>
                                             <div class="tst-author">
                                                  <h4>Andrio</h4>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="contact-image">
                              <img src="assets/images/contact-1-600x400.jpg" class="img-responsive" alt="Smiling Two Girls">
                         </div>
                    </div>
